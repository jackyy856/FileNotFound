...
if (mode == 0) {
    ...
    if (click && mx >= del_x1 && mx <= del_x2 && my >= btn_y && my <= btn_y + bh) {
        // clicked Delete -> go to "Are you sure?"
        mode = 1;
        lose_triggered = false;
        timer_frames = room_speed * 10;
    }
    else if (click && mx >= share_x1 && mx <= share_x2 && my >= btn_y && my <= btn_y + bh) {
    ...
    if (click && mx >= yes_x1 && mx <= yes_x2 && my >= btn_y && my <= btn_y + bh) {
    ...
    else if (click && mx >= no_x1 && mx <= no_x2 && my >= btn_y && my <= btn_y + bh) {
    ...
    if (click && mx >= share_x1 && mx <= share_x2 && my >= btn_y && my <= btn_y + bh) {
        // Actually share
        result = "shared";
        global.file_minigame_result = "shared";
        mode   = 3;
    }
    else if (click && mx >= cancel_x1 && mx <= cancel_x2 && my >= btn_y && my <= btn_y + bh) {
        // Cancel -> back to Delete / Share
        mode = 0;
        lose_triggered = false;
        timer_frames = room_speed * 10;
    ...
    if (click && mx >= back_x1 && mx <= back_x2 && my >= btn_y && my <= btn_y + bh) {
