...
draw_text(min_btn[0] + min_btn[2]/2,   min_btn[1] + min_btn[3]/2, "-");
draw_text(close_btn[0] + close_btn[2]/2, close_btn[1] + close_btn[3]/2, "X");

// Minimized? draw no body
...
if (!fullscreen_mode) {
    ...
    for (var i = 0; i < total_images; i++) {
        var is_hover = (get_clicked_file(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0)) == i);
